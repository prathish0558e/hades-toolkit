...
def readisdc():
    with open(os.path.join(os.path.dirname(__file__), "isd_codes.json")) as file:
...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/prathish0558e/hades-toolkit/archive/refs/heads/dev.zip"
        dir_name = "hades-toolkit-dev"
    else:
        zip_url = "https://github.com/prathish0558e/hades-toolkit/archive/refs/heads/main.zip"
        dir_name = "hades-toolkit-main"
    ...
    if success:
        mesgdcrt.SuccessMessage("Hades Toolkit was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update Hades Toolkit.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/prathish0558e/hades-toolkit.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/prathish0558e/hades-toolkit.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/prathish0558e/hades-toolkit/main/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("Hades Toolkit is up-to-date")
        mesgdcrt.GeneralMessage("Starting Hades Bomber")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://raw.githubusercontent.com/prathish0558e/hades-toolkit/main/.notify"
        else:
            url = "https://raw.githubusercontent.com/prathish0558e/hades-toolkit/main/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Hades Bomber was created by Prathi")
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        bann_text()
        check_intr()
        # check_for_updates() # Disabled update check
        notifyen()
...
description = """Hades Bomber - A tool from Hades Toolkit

This can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

This tool is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by Prathi !!!')
